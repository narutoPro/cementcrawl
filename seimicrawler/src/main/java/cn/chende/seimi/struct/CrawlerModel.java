 ...
 */
package cn.chende.seimi.struct;


import cn.chende.seimi.utils.GenericUtils;
import cn.chende.seimi.utils.StrFormatUtil;
import cn.chende.seimi.annotation.Crawler;
import cn.chende.seimi.core.SeimiQueue;
import cn.chende.seimi.def.BaseSeimiCrawler;
import cn.chende.seimi.http.HttpMethod;
import cn.chende.seimi.http.SeimiHttpType;
import cn.chende.seimi.http.okhttp.CookiesManager;
...
public class CrawlerModel {
    ...
    private void init() {
        ...
        Assert.notNull(c, StrFormatUtil.info("crawler {} lost annotation @Crawler!", clazz.getName()));
