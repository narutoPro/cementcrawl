package cn.chende.seimi.http.okhttp;

import cn.chende.seimi.spring.common.CrawlerCache;
import cn.chende.seimi.struct.CrawlerModel;
import cn.chende.seimi.config.SeimiConfig;
import cn.chende.seimi.def.BaseSeimiCrawler;
import cn.chende.seimi.exception.SeimiProcessExcepiton;
import cn.chende.seimi.http.HttpMethod;
import cn.chende.seimi.http.SeimiAgentContentType;
...
public class OkHttpRequestGenerator {
    public static Request.Builder getOkHttpRequesBuilder(cn.chende.seimi.struct.Request seimiReq, CrawlerModel crawlerModel){
