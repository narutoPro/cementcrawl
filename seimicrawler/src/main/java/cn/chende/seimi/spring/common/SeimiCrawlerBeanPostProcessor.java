package cn.chende.seimi.spring.common;

import cn.chende.seimi.annotation.Crawler;
import cn.chende.seimi.annotation.Interceptor;
import cn.chende.seimi.core.SeimiInterceptor;
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (crawler != null) {
            if (BaseSeimiCrawler.class.isAssignableFrom(beanClass)) {
                ...
                logger.error("Crawler={} not extends {@link BaseSeimiCrawler}", beanClass.getName());
            }
        }
        ...
        if (interceptor != null) {
            if (SeimiInterceptor.class.isAssignableFrom(beanClass)) {
                ...
                logger.error("find class = {}, has @Interceptor but not implement SeimiInterceptor", beanClass.getName());
            }
        }
        return bean;
    }
